...
<html lang="en">    
    <head>
        ...
        <meta name="description" content="omnifood is a premium food delivery service with the mission to bringe affordable and healty meals to as many people as possible">
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-feature">
                    <i class="icon ion-ios-logo-twitter icon-small"></i>
        ...
        <footer>
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    <li><a href="#"><i class="icon ion-ios-globe"></i></a></li>
                    <li><a href="#"><i class="icon ion-ios-send"></i></a></li>
                    <li><a href="#"><i class="icon ion-ios-female"></i></a></li>
                    <li><a href="#"><i class="icon ion-ios-grid"></i></a></li>
                </ul>
                </div>
            </div>
            <div class="row">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-137200412-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-137200412-1');
</script>
...
<link rel="stylesheet" type="text/css" href="vendors/css/ionicons.min.css">  line6

<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.css">  line6
...
<li><a href="#"><i class="icon ion-ios-logo-twitter"></i></a></li>

[![](https://data.jsdelivr.com/v1/package/npm/respond.js/badge)](https://www.jsdelivr.com/package/npm/respond.js)
[![](https://data.jsdelivr.com/v1/package/npm/html5shiv/badge)](https://www.jsdelivr.com/package/npm/html5shiv)
[![](https://data.jsdelivr.com/v1/package/npm/selectivizr/badge)](https://www.jsdelivr.com/package/npm/selectivizr)
